...
# admin.site.register(TaskStatus, AdminTaskStatus)

# class AdminFilesTaskStatus(admin.ModelAdmin):
#     list_display = ('id', 'taskStatusFK', 'filetype')
#     list_display_links = ('id', 'taskStatusFK', 'filetype')
#     search_fields = ('taskStatusFK',)
#     list_per_page = 10

# admin.site.register(FilesTaskStatus, AdminFilesTaskStatus)

# class AdminTaskEquipments(admin.ModelAdmin):
#     list_display = ('id', 'taskFK', 'equipmentFK')
#     list_display_links = ('id', 'taskFK', 'equipmentFK')
#     search_fields = ('equipmentFK',)
#     list_per_page = 10

# admin.site.register(TasksEquipments, AdminTaskEquipments)

# class AdminEnvironmentsAssignees(admin.ModelAdmin):
#     list_display = ('id', 'environmentFK', 'assigneeFK')
#     list_display_links = ('id', 'environmentFK', 'assigneeFK')
#     search_fields = ('environmentFK',)
#     list_per_page = 10

# admin.site.register(EnvironmentsAssignees, AdminEnvironmentsAssignees)
...
# class AdminClassDivisions(admin.ModelAdmin):
#     list_display = ('id', 'name', 'classFK')
#     list_display_links = ('id', 'name', 'classFK')
#     search_fields = ('name', 'classFK',)
#     list_per_page = 10

# admin.site.register(ClassDivisions, AdminClassDivisions)
...
#     search_fields = ('classFK', 'reporterFK',)
#     list_per_page = 10
